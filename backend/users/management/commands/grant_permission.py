# backend/users/management/commands/grant_permission.py
# Purpose: management command to grant a global permission to a user.
# Usage: python manage.py grant_permission <username> <app_label.codename>
...
class Command(BaseCommand):
    help = "Grant a global permission to a user. Usage: grant_permission <username> <app_label.codename>"
    ...
    def handle(self, *args, **options):
        ...
        out = {"result": "ok", "username": username, "granted_permission": perm_str}
